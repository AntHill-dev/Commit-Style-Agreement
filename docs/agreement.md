...
* **refact**: рефакторинг определенного участка кодовой базы. \#TODO: далее можно выделить подмножества
